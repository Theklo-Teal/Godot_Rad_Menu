...
- The top and left anchors are used for offsetting item placement.
...
You then may have a script extending RadialMenu to override how background for sectors is drawn, as well as the center and an overall background.
